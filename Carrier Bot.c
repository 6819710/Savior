...
#pragma config(Sensor, S4,     backSensor,     sensorEV3_Ultrasonic)
#pragma config(Motor,  motorA,          beltFront,     tmotorEV3_Large, PIDControl, reversed, encoder)
#pragma config(Motor,  motorB,          leftMotor,     tmotorEV3_Large, PIDControl, driveLeft, encoder)
#pragma config(Motor,  motorC,          rightMotor,    tmotorEV3_Large, PIDControl, driveRight, encoder)
#pragma config(Motor,  motorD,          beltBack,      tmotorEV3_Large, PIDControl, encoder)
